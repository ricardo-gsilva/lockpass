  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<ConfigController, ConfigState>(
      ...
      listener: (context, state) {
        switch (state.status) {
          case ConfigDeleteAccountSuccess():
                    ...
                    child: BlocBuilder<ConfigController, ConfigState>(builder: (context, state) {
                      ...
                      return SingleChildScrollView(
                        child: Column(
                          ...
                          children: [
                            const TextCustom(
                              text: CoreStrings.deleteAccountAction,
                            ...
                            const TextCustom(
                              text: CoreStrings.deleteAccountConfirmation,
                              color: CoreColors.textSecundary,
                              fontSize: 15,
                            ),
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                ButtonCustom(
                                  ...
                                  text: isLoading ? CoreStrings.deleting : CoreStrings.delete,
                                  onPressed: () async {
