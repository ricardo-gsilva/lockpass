...
class RestoreBackupAutomaticBottomSheet extends StatelessWidget {
  const RestoreBackupAutomaticBottomSheet({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<ConfigController, ConfigState>(
      ...
      listener: (context, state) {
        switch (state.status) {
          case ConfigRestoreBackupAutomaticSuccess(:final message):
                          ...
                          child: Column(
                            ...
                            children: [
                              Flex(
                                ...
                                children: [
                                  ...
                                  IconButtonCustom(
                                      ...
                                      icon: CoreIcons.info,
                                      onPressed: () {
                                        showInfo(context, CoreStrings.loadAutomaticBackupDetail);
                                      })
                                ],
                              ),
                              SizedBox(height: 15),
                              const TextCustom(
                                ...
                                text: CoreStrings.loadAutomaticBackupQuestion,
                                fontSize: 16,
                                color: CoreColors.textSecundary,
                              ),
                              SizedBox(height: 24),
                                ...
                                children: [
                                  ...
                                  ButtonCustom(
                                    ...
                                    onPressed: isLoading
                                        ? null
                                        : () {
                                            controller.restoreAutomaticBackup();
                                          },
                                  )
                                ],
                              ),
