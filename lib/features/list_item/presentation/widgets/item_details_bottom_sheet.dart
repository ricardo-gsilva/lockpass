...
import 'package:lockpass/features/listItem/presentation/widgets/item_edit_view_widget.dart';
import 'package:lockpass/features/listItem/presentation/widgets/item_info_view_widget.dart';
...
class ItemDetailsBottomSheet extends StatefulWidget {
  ...
  final List<GroupsEntity> listGroups;
...
class _ItemDetailsBottomSheetState extends State<ItemDetailsBottomSheet> {
  ...
  void _resetControllers() {
    groupController.text = widget.item.group;
